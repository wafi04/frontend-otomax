        ...
        <div className="mt-4 lg:mt-8">
          <div className="container flex w-full flex-col gap-4 lg:hidden">
            <div className="h-10 items-center justify-center rounded-xl bg-muted p-1 text-muted-foreground flex w-full">
              <button className="h-10 items-center justify-center rounded-xl bg-muted p-1 text-muted-foreground flex w-full">
                Transaksi
              </button>
              <button className="inline-flex items-center justify-center whitespace-nowrap rounded-lg px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm w-full">
                Keterangan
              </button>
            </div>
          </div>
